...
{
    default errorCode[] getErrorCodes()
    {
        return getErrorCodes(com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default errorCode[] getErrorCodes(java.util.Map<String, String> context)
    {
        return _iceI_getErrorCodesAsync(context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<errorCode[]> getErrorCodesAsync()
    {
        return _iceI_getErrorCodesAsync(com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<errorCode[]> getErrorCodesAsync(java.util.Map<String, String> context)
    {
        return _iceI_getErrorCodesAsync(context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<errorCode[]> _iceI_getErrorCodesAsync(java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<errorCode[]> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "getErrorCodes", null, sync, null);
    ...
    default void resetErrorCodes()
    {
        resetErrorCodes(com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default void resetErrorCodes(java.util.Map<String, String> context)
    {
        _iceI_resetErrorCodesAsync(context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<Void> resetErrorCodesAsync()
    {
        return _iceI_resetErrorCodesAsync(com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Void> resetErrorCodesAsync(java.util.Map<String, String> context)
    {
        return _iceI_resetErrorCodesAsync(context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Void> _iceI_resetErrorCodesAsync(java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<Void> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "resetErrorCodes", null, sync, null);
