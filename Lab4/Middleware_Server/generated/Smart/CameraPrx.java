...
{
    default boolean setPosition(cameraPosition position)
        throws ArgumentOutOfRangeException
    {
        return setPosition(position, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default boolean setPosition(cameraPosition position, java.util.Map<String, String> context)
        throws ArgumentOutOfRangeException
    {
        try
        {
            return _iceI_setPositionAsync(position, context, true).waitForResponseOrUserEx();
        }
    ...
    default java.util.concurrent.CompletableFuture<java.lang.Boolean> setPositionAsync(cameraPosition position)
    {
        return _iceI_setPositionAsync(position, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<java.lang.Boolean> setPositionAsync(cameraPosition position, java.util.Map<String, String> context)
    {
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<java.lang.Boolean> _iceI_setPositionAsync(cameraPosition iceP_position, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<java.lang.Boolean> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "setPosition", null, sync, _iceE_setPosition);
    ...
    {
        return getLocked(com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default boolean getLocked(java.util.Map<String, String> context)
    {
        return _iceI_getLockedAsync(context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<java.lang.Boolean> getLockedAsync()
    {
        return _iceI_getLockedAsync(com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<java.lang.Boolean> getLockedAsync(java.util.Map<String, String> context)
    {
        return _iceI_getLockedAsync(context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<java.lang.Boolean> _iceI_getLockedAsync(java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<java.lang.Boolean> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "getLocked", null, sync, null);
        f.invoke(true, context, null, null, istr -> {
                     boolean ret;
                     ret = istr.readBool();
                     return ret;
    ...
    {
        setLocked(locked, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default void setLocked(boolean locked, java.util.Map<String, String> context)
    {
        _iceI_setLockedAsync(locked, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<Void> setLockedAsync(boolean locked)
    {
        return _iceI_setLockedAsync(locked, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Void> setLockedAsync(boolean locked, java.util.Map<String, String> context)
    {
        return _iceI_setLockedAsync(locked, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Void> _iceI_setLockedAsync(boolean iceP_locked, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<Void> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "setLocked", null, sync, null);
